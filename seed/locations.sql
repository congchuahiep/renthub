/* === Vietnamese locations_province Database Dataset for PostgreSQL/MySQL === */
/* Created at:  Sat, 01 Mar 2025 21:28:48 +0700 */
/* Reference: https://github.com/ThangLeQuoc/vietnamese-locations_province-database */
/* =============================================== */

-- DATA for locations_administrativeregion --
INSERT INTO locations_administrativeregion(id,name,name_en,code_name,code_name_en) VALUES(1,'Đông Bắc Bộ','Northeast','dong_bac_bo','northest');
INSERT INTO locations_administrativeregion(id,name,name_en,code_name,code_name_en) VALUES(2,'Tây Bắc Bộ','Northwest','tay_bac_bo','northwest');
INSERT INTO locations_administrativeregion(id,name,name_en,code_name,code_name_en) VALUES(3,'Đồng bằng sông Hồng','Red River Delta','dong_bang_song_hong','red_river_delta');
INSERT INTO locations_administrativeregion(id,name,name_en,code_name,code_name_en) VALUES(4,'Bắc Trung Bộ','North Central Coast','bac_trung_bo','north_central_coast');
INSERT INTO locations_administrativeregion(id,name,name_en,code_name,code_name_en) VALUES(5,'Duyên hải Nam Trung Bộ','South Central Coast','duyen_hai_nam_trung_bo','south_central_coast');
INSERT INTO locations_administrativeregion(id,name,name_en,code_name,code_name_en) VALUES(6,'Tây Nguyên','Central Highlands','tay_nguyen','central_highlands');
INSERT INTO locations_administrativeregion(id,name,name_en,code_name,code_name_en) VALUES(7,'Đông Nam Bộ','Southeast','dong_nam_bo','southeast');
INSERT INTO locations_administrativeregion(id,name,name_en,code_name,code_name_en) VALUES(8,'Đồng bằng sông Cửu Long','Mekong River Delta','dong_bang_song_cuu_long','southwest');
-- ----------------------------------

-- DATA for locations_administrativeunit --
INSERT INTO locations_administrativeunit(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(1,'Thành phố trực thuộc trung ương','Municipality','Thành phố','City','thanh_pho_truc_thuoc_trung_uong','municipality');
INSERT INTO locations_administrativeunit(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(2,'Tỉnh','Province','Tỉnh','Province','tinh','province');
INSERT INTO locations_administrativeunit(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(3,'Thành phố thuộc thành phố trực thuộc trung ương','Municipal city','Thành phố','City','thanh_pho_thuoc_thanh_pho_truc_thuoc_trung_uong','municipal_city');
INSERT INTO locations_administrativeunit(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(4,'Thành phố thuộc tỉnh','Provincial city','Thành phố','City','thanh_pho_thuoc_tinh','provincial_city');
INSERT INTO locations_administrativeunit(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(5,'Quận','Urban district','Quận','District','quan','urban_district');
INSERT INTO locations_administrativeunit(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(6,'Thị xã','District-level town','Thị xã','Town','thi_xa','district_level_town');
INSERT INTO locations_administrativeunit(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(7,'Huyện','District','Huyện','District','huyen','district');
INSERT INTO locations_administrativeunit(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(8,'Phường','Ward','Phường','Ward','phuong','ward');
INSERT INTO locations_administrativeunit(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(9,'Thị trấn','Commune-level town','Thị trấn','Township','thi_tran','commune_level_town');
INSERT INTO locations_administrativeunit(id,full_name,full_name_en,short_name,short_name_en,code_name,code_name_en) VALUES(10,'Xã','Commune','Xã','Commune','xa','commune');
-- ----------------------------------

-- DATA for locations_province --
INSERT INTO locations_province(code,name,name_en,full_name,full_name_en,code_name,administrative_unit_id,administrative_region_id) VALUES
...
-- DATA for locations_district --
INSERT INTO locations_district(code,name,name_en,full_name,full_name_en,code_name,province_id,administrative_unit_id) VALUES
...
-- DATA for locations_ward --
INSERT INTO locations_ward(code,name,name_en,full_name,full_name_en,code_name,district_id,administrative_unit_id) VALUES
